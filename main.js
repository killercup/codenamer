...
(function() {
  var DEBUG, PARTS, TWITTER, adnButton, bind, cats, final_name, name_parts, optionsFor, parts_, selects, sourceInfo, tweetButton, _i, _ref, _results;
  ...
  final_name = bind(function() {
    ...
    return name_parts.all().map(function(cat) {
      var vals, _ref2;
      vals = (_ref2 = cats[cat]) != null ? _ref2.values : void 0;
